...
public class BotResponses {
    ...
    public static final class ProductController {
        ...
        public static final class onDisplayResults {
            ...
            public static final String isPartOfForeignCorporationText = "Nie jest częścią zagranicznego koncernu";
        }
    }
    ...
    public static final class ReportController {
        ...
        public static final class onInvalidInput4 {
            public static final String text = "Nie rozumiem. Chcesz załączyć dodatkowe zdjęcia produktu do raportu czy nie?";
            public static final String quickReplyNo = onAskForAddtionalImages.quickReplyNo;
            public static final String quickReplyYes = onAskForAddtionalImages.quickReplyYes;
        }

        public static final class onAskForAddtionalImages {
            public static final String text = "Czy chcesz załączyć do raportu dodatkowe zdjęcia produktu?";
            public static final String quickReplyNo = "Nie, nie trzeba.";
            public static final String quickReplyYes = "Tak, chcę załączyć.";
        }
        ...
        public static final class onText {
            public static final String text = "Super! Prześlij nam teraz jakieś zdjęcia etykiety produktu do raportu.";
        }
